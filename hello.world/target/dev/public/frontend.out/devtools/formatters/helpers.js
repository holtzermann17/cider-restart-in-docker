...
var G__47578 = devtools.prefs.pref.call(null,v);
v = G__47578;
continue;
} else {
return v;
...
}catch (e47581){var _e__46593__auto__ = e47581;
return false;
}})();
...
}catch (e47585){var _e__46593__auto__ = e47585;
return false;
}})();
...
}catch (e47587){var _e__46593__auto__ = e47587;
return false;
}}
}
});
...
var vec__47589 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__47589,(0),null);
var name = cljs.core.nth.call(null,vec__47589,(1),null);
...
return cljs.core.some.call(null,(function (p1__47592_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__47592_SHARP_);
}),template);
});
