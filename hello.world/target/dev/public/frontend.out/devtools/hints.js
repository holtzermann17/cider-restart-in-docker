...
var map__49777 = top_item;
var map__49777__$1 = ((((!((map__49777 == null)))?(((((map__49777.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49777.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49777):map__49777);
var file = cljs.core.get.call(null,map__49777__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__49777__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__49777__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e49776){var _e = e49776;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___49779 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___49779)){
var seen_errors_49780 = temp__5718__auto___49779;
if(cljs.core.truth_(seen_errors_49780.has(self))){
} else {
seen_errors_49780.add(self);

var temp__5720__auto___49781 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___49781)){
var sense_49782 = temp__5720__auto___49781;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_49782)].join('');
} else {
}
}
} else {
