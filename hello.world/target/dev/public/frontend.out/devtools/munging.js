...
var o47476 = temp__5718__auto__;
var temp__5718__auto____$1 = (o47476["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o47477 = temp__5718__auto____$1;
return (o47477["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__46586__auto__ = f;
return (o__46586__auto__["toString"]).call(o__46586__auto__);
} else {
return "";
}
}catch (e47478){var _ = e47478;
return "";
}});
...
try{var o__46586__auto___47480 = t;
(o__46586__auto___47480["cljs$lang$ctorPrWriter"]).call(o__46586__auto___47480,t,writer);
}catch (e47479){var __47481 = e47479;
}
...
var char_code = (function (){var o__46586__auto__ = (new String(char$));
return (o__46586__auto__["charCodeAt"]).call(o__46586__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__46586__auto__ = String;
return (o__46586__auto__["fromCharCode"]).call(o__46586__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__47482 = num_code;
switch (G__47482) {
case (1):
return (185);
...
var o__46586__auto__ = String;
return (o__46586__auto__["fromCharCode"]).call(o__46586__auto__,superscript_code);
});
/**
...
}catch (e47484){var _e__46593__auto__ = e47484;
return false;
}})())){
...
var vec__47485 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__47485,(0),null);
...
var or__3922__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var o47488 = temp__5718__auto__;
var temp__5718__auto____$1 = (o47488["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o47489 = temp__5718__auto____$1;
return (o47489["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___47496 = arguments.length;
var i__4500__auto___47497 = (0);
while(true){
if((i__4500__auto___47497 < len__4499__auto___47496)){
args__4502__auto__.push((arguments[i__4500__auto___47497]));

var G__47498 = (i__4500__auto___47497 + (1));
i__4500__auto___47497 = G__47498;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__47492){
var vec__47493 = p__47492;
var ns_detector = cljs.core.nth.call(null,vec__47493,(0),null);
...
var G__47499 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__47500 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__47499;
remaining_tokens = G__47500;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq47490){
var G__47491 = cljs.core.first.call(null,seq47490);
var seq47490__$1 = cljs.core.next.call(null,seq47490);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47491,seq47490__$1);
});
...
var vec__47504 = cljs.core.split_with.call(null,(function (p1__47503_SHARP_){
return cljs.core.not_EQ_.call(null,p1__47503_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__47504,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__47504,(1),null);
...
var vec__47507 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__47507,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__47507,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__47510 = cljs.core.rest.call(null,remaining_tokens);
var G__47511 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__47510;
name_tokens = G__47511;
continue;
} else {
...
var vec__47514 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__47514,(0),null);
var arity = cljs.core.nth.call(null,vec__47514,(1),null);
var vec__47517 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__47517,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__47517,(1),null);
var vec__47520 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__47520,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__47520,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__47520,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__47520,(3),null);
...
var vec__47526 = result;
var munged_ns = cljs.core.nth.call(null,vec__47526,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__47526,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__47526,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__47526,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__47526,(4),null);
var arity = cljs.core.nth.call(null,vec__47526,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__47530 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__47530,(0),null);
var args = cljs.core.nth.call(null,vec__47530,(1),null);
var vec__47533 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__47533,(0),null);
var name = cljs.core.nth.call(null,vec__47533,(1),null);
...
var G__47536 = (arity + (1));
var G__47537 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__47538){
var vec__47539 = p__47538;
var arity = cljs.core.nth.call(null,vec__47539,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__47539,(1),null);
...
return cljs.core.get.call(null,arities,p1__47542_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__47543_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___47550 = arguments.length;
var i__4500__auto___47551 = (0);
while(true){
if((i__4500__auto___47551 < len__4499__auto___47550)){
args__4502__auto__.push((arguments[i__4500__auto___47551]));

var G__47552 = (i__4500__auto___47551 + (1));
i__4500__auto___47551 = G__47552;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__47546){
var vec__47547 = p__47546;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__47547,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq47544){
var G__47545 = cljs.core.first.call(null,seq47544);
var seq47544__$1 = cljs.core.next.call(null,seq47544);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47545,seq47544__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__47555__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__47555__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__47555__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__47555__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__47556 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__47556,(0),null);
var fn_name = cljs.core.nth.call(null,vec__47556,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__47556,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__47556,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__47556,(4),null);
var arity = cljs.core.nth.call(null,vec__47556,(5),null);
...
var o__46586__auto__ = f;
return (o__46586__auto__["getBasis"]).call(o__46586__auto__);
});
/**
...
}catch (e47560){var _e__46593__auto__ = e47560;
...
var G__47561 = (obj[cljs.core.first.call(null,path)]);
var G__47562 = cljs.core.rest.call(null,path);
obj = G__47561;
path = G__47562;
continue;
} else {
...
return (function (accum,p__47563){
var vec__47564 = p__47563;
var bit = cljs.core.nth.call(null,vec__47564,(0),null);
var protocol = cljs.core.nth.call(null,vec__47564,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__47567){
...
var selector = cljs.core.nth.call(null,vec__47568,(2),null);
...
return (function (p__47572){
var vec__47573 = p__47572;
var munged_name = cljs.core.nth.call(null,vec__47573,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__47573,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__47573,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__47571_SHARP_){
return (obj[cljs.core.first.call(null,p1__47571_SHARP_)]);
});})(name,sorted_matches,vec__47573,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
